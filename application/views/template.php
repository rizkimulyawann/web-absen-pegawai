...
<head>
    ...
    <title>Absensi Baitul Mal</title>
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <img src="<?= base_url('assets/img/BAITULMAL..png') ?>" alt="" class="img-fluid">
                    </a>
                </div>
                <ul class="nav">
                    <li class="nav-item">
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2023 <a href="https://www.facebook.com/baitulmallhokseumawe/">Baitul Mal</a>
                        </p>
                    </nav>
                </div>
            </footer>
